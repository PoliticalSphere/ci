...
# ==============================================================================
# Political Sphere — Gate Common (Facade)
# ------------------------------------------------------------------------------
# Purpose:
...
. "${_gate_script_dir}/../core/path-resolution.sh"
...
# shellcheck source=tools/scripts/core/gate-logging.sh
. "${core_scripts}/gate-logging.sh"
...
# shellcheck source=tools/scripts/core/trap-handlers.sh
. "${core_scripts}/trap-handlers.sh"
