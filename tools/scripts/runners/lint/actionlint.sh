...
#
# Usage:
#   bash tools/scripts/runners/lint/actionlint.sh
#   PS_FULL_SCAN=1 bash tools/scripts/runners/lint/actionlint.sh
#   ACTIONLINT_BIN=/path/to/actionlint bash tools/scripts/runners/lint/actionlint.sh
# ==============================================================================
