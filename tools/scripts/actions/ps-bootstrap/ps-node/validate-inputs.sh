...
PS_NODE_VALIDATION_START="$(date +%s)"

workspace_root="${GITHUB_WORKSPACE:-$(pwd)}"

# shellcheck source=tools/scripts/core/gha-helpers.sh
. "${workspace_root}/tools/scripts/core/gha-helpers.sh"
# shellcheck source=tools/scripts/core/validation.sh
. "${workspace_root}/tools/scripts/core/validation.sh"
# shellcheck source=tools/scripts/actions/ps-bootstrap/shared/validate-inputs-common.sh
. "${workspace_root}/tools/scripts/actions/ps-bootstrap/shared/validate-inputs-common.sh"
# shellcheck source=tools/scripts/core/string.sh
. "${workspace_root}/tools/scripts/core/string.sh"
...
# Performance metrics
PS_NODE_VALIDATION_END="$(date +%s)"
PS_NODE_VALIDATION_DURATION="$((PS_NODE_VALIDATION_END - PS_NODE_VALIDATION_START))"
emit_env "PS_NODE_VALIDATION_DURATION_SEC" "${PS_NODE_VALIDATION_DURATION}"
