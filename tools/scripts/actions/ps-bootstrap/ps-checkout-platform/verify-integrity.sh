#!/usr/bin/env bash
# ==============================================================================
# Political Sphere — Script: verify-integrity.sh
# License: Proprietary
# ==============================================================================
# ps_header_v: 6
#
...
# -----------------------------------------------------------------------------
# meta:
#   file_id: tools/scripts/actions/ps-bootstrap/ps-checkout-platform/verify-integrity.sh
#   file_type: script
#   language: bash
#   version: 1.0.0
#   status: active
...
#     - PS_PLATFORM_REQUIRE_PINNED_REF: Whether pinned ref is required (0/1)
#
# ==============================================================================
...
# -----------------------------------------------------------------------------
if [[ "${PS_PLATFORM_REQUIRE_PINNED_REF}" == "1" ]] && [[ ! "${PS_PLATFORM_REF}" =~ ^[0-9a-fA-F]{40}$ ]]; then
  fail "platform ref must be a full 40-char commit SHA when" \
    "require_pinned_ref=1 (got ${PS_PLATFORM_REF})"
fi
