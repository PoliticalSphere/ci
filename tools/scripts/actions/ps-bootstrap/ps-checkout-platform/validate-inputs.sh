#!/usr/bin/env bash
# ==============================================================================
# Political Sphere — Script: validate-inputs.sh
# License: Proprietary
# ==============================================================================
# ps_header_v: 6
#
...
# -----------------------------------------------------------------------------
# meta:
#   file_id: tools/scripts/actions/ps-bootstrap/ps-checkout-platform/validate-inputs.sh
#   file_type: script
#   language: bash
#   version: 1.0.0
#   status: active
...
#     - tools/scripts/actions/ps-bootstrap/shared/checkout-validate-common.sh
#   external: [bash]
#
# ENVIRONMENT (INPUT)
# -----------------------------------------------------------------------------
...
# Normalize booleans
# -----------------------------------------------------------------------------
require_pinned="$(require_bool "inputs.require_pinned_ref" \
  "${PS_REQUIRE_PINNED_REF_INPUT:-false}")"
clean="$(require_bool "inputs.clean_path" \
...
PS_ENV_PREFIX="PS_PLATFORM" \
  bash "$ws/tools/scripts/actions/ps-bootstrap/shared/checkout-validate-common.sh"
