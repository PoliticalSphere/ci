...
import { fail, getRepoRoot, readYamlFile, section } from '../helpers/test-helpers.js';
...
const scriptMatch = content.match(/write-summary\.sh"$/m);
if (!scriptMatch) fail('ps-write-summary must invoke write-summary.sh');
...
if (!fs.existsSync(scriptPath)) fail('write-summary.sh not found');
