...
// Minimal LinterConfig used by tests (keeps fixtures independent from src/cli types)
import type { LinterEnforcement } from '../../../cli/config/linter-registry.ts';
