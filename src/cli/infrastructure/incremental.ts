...
export class IncrementalExecutionTracker {
  ...
  /**
   * Instantiate a tracker and preseed known linter file patterns.
   */
  constructor() {
  ...
  /**
   * Determine whether the given linter should run based on tracked file changes.
   */
  ...
  /**
   * Clear cached change detection data for a single linter.
   */
  ...
  /**
   * Return runtime stats for the incremental tracker.
   */
  getStats(): {
...
/**
 * Global incremental execution tracker instance (null when disabled).
 */
...
/**
 * Replace the global incremental tracker instance.
 */
