...
import { getGlobalTracker } from './incremental.ts';
...
/**
 * Execute a single linter with retry logic, tracing, and telemetry.
 */
...
/**
 * Execute multiple linters in parallel with concurrency control.
 */
